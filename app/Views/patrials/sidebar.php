...
<aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
    <div class="sidebar-header d-flex align-items-center justify-content-start">
        <a href="<?= base_url('/'); ?>" class="navbar-brand">
            ...
            <div class="logo-main">
                <div class="logo-normal">
                    ...
                    <img src="<?= base_url('Assets/img/data_instansi/').$data_instansi['logo_instansi']; ?>"
                        class="img-fluid" alt="logo" style="width: 50px; height: 50px;">
                </div>
                <div class="logo-mini">
                    <img src="<?= base_url('Assets/img/data_instansi/').$data_instansi['logo_instansi']; ?>"
                        class="img-fluid" alt="logo" style="width: 50px; height: 50px;">
            ...
            <!--logo End-->
            <h4 class="logo-title">Arsip Surat</h4>
        </a>
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active == 'data_instansi' ? 'active' : ''; ?>"
                        ...
                        <span class="item-name">Data Instansi</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#template_surat" role="button"
                        aria-expanded="false" aria-controls="template_surat">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                        ...
                        <span class="item-name">Template Surat</span>
                        <i class="right-icon">
                    ...
                    <ul class="sub-nav collapse" id="template_surat" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?= $active == 'referensi_jenis_surat' ? 'active' : ''; ?>"
                                href="<?= base_url('Jenis_surat/Referensi'); ?>">
                                <i class="icon">
                                ...
                                <span class="item-name">Referensi Surat</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $active == 'jenis_surat' ? 'active' : ''; ?>"
                                href="<?= base_url('Jenis_surat'); ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"></i>
                                <span class="item-name">Jenis Surat</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <!-- data pegawai -->
                <li class="nav-item">
                    <a class="nav-link <?= $active == 'Pegawai' ? 'active' : ''; ?>" href="<?= base_url('Pegawai'); ?>">
                        <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $active == 'external' ? 'active' : ''; ?>"
                        href="<?= base_url('External'); ?>">
                ...
                <li class="nav-item">
                    ...
                    <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?= $active == 'surat_masuk' ? 'active' : ''; ?>"
                                href="<?= base_url('Surat_masuk'); ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= $active == 'Surat_keluar' ? 'active' : ''; ?>"
                                href="<?= base_url('Surat_keluar'); ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#laporan_suratMasuk" role="button"
                        aria-expanded="false" aria-controls="laporan_suratMasuk">
                        <i class="icon">
                            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="icon-20">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <ul class="sub-nav collapse" id="laporan_suratMasuk" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link <?= $active == 'Laporan_Surat_masuk' ? 'active' : ''; ?>"
                                href="<?= base_url('Laporan/Surat_masuk'); ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"></i>
                                <span class="item-name">Laporan Surat Masuk
                                </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= $active == 'Laporan_Surat_keluar' ? 'active' : ''; ?>"
                                href="<?= base_url('Laporan/Surat_keluar'); ?>">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                        viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                ...
                                <i class="sidenav-mini-icon"></i>
                                <span class="item-name">Laporan Surat Keluar
                                </span>
                            </a>
                        </li>
