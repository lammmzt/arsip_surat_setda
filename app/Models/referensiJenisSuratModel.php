...
class referensiJenisSuratModel extends Model
{
    ...
    protected $allowedFields = ['nama_referensi_jenis_surat','tipe_referensi_jenis_surat', 'kode_referensi_jenis_surat','ket_referensi_jenis_surat', 'status_referensi_jenis_surat','id_referensi_jenis_surat','created_at', 'updated_at'];
